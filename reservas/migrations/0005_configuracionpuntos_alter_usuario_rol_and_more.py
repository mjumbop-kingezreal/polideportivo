...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='reserva',
            constraint=models.UniqueConstraint(condition=models.Q(('estado__in', ['confirmada', 'asistida'])), fields=('cancha', 'fecha', 'hora_inicio', 'hora_fin'), name='unique_reserva_activa_por_franja'),
        ),
    ]
